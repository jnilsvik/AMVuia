...
VALUES ('Orbital_Sander', '', 0, 20, 'Various_Tools', '1', '0', null),
       ('Belt_Sander', '', 0, 20, 'Various_Tools', '1', '0', null),
       ('Hand_Plane', '', 0, 20, 'Various_Tools', '1', '0', null),
       ('Miter_Saw', '', 0, 20, 'Various_Tools', '1', '0', null),
       ('Grass_Trimmer','', 0, 20, 'Various_Tools', '1', '0', null),
       ('Hammer_Drill','', 0, 20, 'Various_Tools', '1', '0', null),
       ('String_Trimmer','', 0, 20, 'Various_Tools', '1', '0', 'Bruker oljeblandet bensin. Bruk kun ferdigblandet 2-takt alkylatbensin (2%). Dette er oljeblandet spesialbensinen med lang holdbarhet som kan kjøpes på bl.a. Felleskjøpet, Biltema og Jula.'),
       ('Air_Compressor','', 0, 20, 'Various_Tools', '1', '0', '• Maks. trykk: 10 bar. Avgitt luftmengde: 255 l/min. Effekt: 1,5 kW.'),
       ('Car_Diagnosis_Tools','', 0, 50, 'Various_Tools', '1', '0', null),
       ('Vibrating_Plate','', 0, 50, 'Various_Tools', '1', '0', 'Vekt: 86 kg. Bruker ren bensin minimum oktantall 95. Motoroljenivå sjekkes før og etter bruk. Oljetype: Shell Ultra Ect 5W-30 (AMV nr. 0095-0069).'),
       ('Tile Cutter_Ceramic','', 0, 20, 'Various_Tools', '1', '0', null),
       ('Automatic_Screwer','', 0, 20, 'Various_Tools', '1', '0', null),
       ('Motorized_Wheelbarrow','', 0, 50, 'Various_Tools', '1', '0', 'Brukermanual er også lagret i beholder på selve utstyret. Viktig å lese dette før bruk. Bruk kun ren blyfri 95 oktan bensin. Sjekk alltid motoroljenivå før oppstart. Sørg for å få en rask opplæring i bruk av dette utstyret før første gangs bruk.'),
       ('Nailgun_Pressurized_Large','', 0, 20, 'Nailguns', '1', '0', null),
       ('Nailgun_Pressurized_Small','', 0, 20, 'Nailguns', '1', '0', null),
       ('Nailgun_Milwaukee_Large','', 0, 20, 'Nailguns', '1', '0', null),
       ('Nailgun_Milwaukee_Medium','', 0, 20, 'Nailguns', '1', '0', null),
       ('Nailgun_Milwaukee_Small','', 0, 20, 'Nailguns', '1', '0', null),
       ('Wood_Splitter','', 0, 50, 'Woodcutting', '1', '0', 'Bruker ren bensin, minimum oktantall 95. Motoroljenivå sjekkes før og etter bruk. Oljetype: Shell Ultra Ect 5W-30 (AMV nr. 0095-0069). Hydraulikkoljenivå sjekkes før og etter bruk. Oljetype: Shell Tellus S2VX 46 (AMV nr. 0095- 0006). Kløyveren har ikke fjæring og tyngdepunktet er forholdsvis høyt så det må utvises  forsiktighet med sleping etter kjøretøy. Dvs. tilpass farten etter forholdene.'),
       ('Tile_Cutter_Wood','', 0, 50, 'Woodcutting', '1', '0', 'Brukermanual er lagret i beholder på selve utstyret. Viktig å lese dette før bruk! Bruk kun ren blyfri 95 oktan bensin. Sjekk alltid motoroljenivå før oppstart. Sørg for å få en rask opplæring i bruk av dette utstyret før første gangs bruk.'),
       ('Trailer_Buggy','', 0, 50, 'Car_Trailers', '1', '0', 'Hentes og leveres ved gassbu/kaldtlager. Husk å ta med vognkort og el.kabel. Hentes i verktøy- eller lagerluke. Pass også på at ikke el. kabel sleper i bakken slik at den blir ødelagt. Normalt bør ikke parkeringsbrems settes på ved lagring da dette ofte fører til at bremser  «henger seg» og blir vanskelige å løsne. Det er leiers ansvar å sørge for at en ikke trekker tilhenger som er tyngre enn det førerkort  og bil tillater. Skaphenger er tenkt brukt til frakt av litt «finere ting» som ikke tåler vann og skitt. Det er derfor viktig at denne tilhengeren ikke brukes til frakt av grus, stein eller andre veldig  skitne gjenstander. Boggihenger har 13-polet el.kontakt. Har du ikke rett kontakt på bilen kan overgang/adapter kjøpes på bl.a. Biltema, Jula og de  fleste bensinstasjoner.'),
       ('Trailer_Small','', 0, 50, 'Car_Trailers', '1', '0', 'Hentes og leveres ved gassbu/kaldtlager. Husk å ta med vognkort og el.kabel. Hentes i verktøy- eller lagerluke. Pass også på at ikke el. kabel sleper i bakken slik at den blir ødelagt. Normalt bør ikke parkeringsbrems settes på ved lagring da dette ofte fører til at bremser  «henger seg» og blir vanskelige å løsne. Det er leiers ansvar å sørge for at en ikke trekker tilhenger som er tyngre enn det førerkort  og bil tillater. Skaphenger er tenkt brukt til frakt av litt «finere ting» som ikke tåler vann og skitt. Det er derfor viktig at denne tilhengeren ikke brukes til frakt av grus, stein eller andre veldig  skitne gjenstander. Liten henger har 7-polet el.kontakt. Har du ikke rett kontakt på bilen kan overgang/adapter kjøpes på bl.a. Biltema, Jula og de  fleste bensinstasjoner.'),
