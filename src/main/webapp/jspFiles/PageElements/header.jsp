...
<header class="p-3 border-bottom amv-bgc-y" style="font-family: Arial,Helvetica,sans-serif">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="login.jsp" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">
                <img src="img/amv.png" class="bi me-2" height="40" role="img" aria-label="Bootstrap" alt="AMV logo">
            </a>

            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li><a href="toolList" class="nav-link px-2 amv-txc-b">TOOL OVERVIEW</a></li>
